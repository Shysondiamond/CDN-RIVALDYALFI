...
/* =========================
    Firebase init (GANTI DENGAN CONFIG KAMU SENDIRI!)
    ========================= */
const firebaseConfig = {
    apiKey: "AIzaSyCMqHfNi_pYHsdirS03_xkCKCur7p-iKP0", // <-- GANTI INI
    authDomain: "forumjeda.firebaseapp.com",
    databaseURL: "https://forumjeda-default-rtdb.firebaseio.com",
    projectId: "forumjeda",
    storageBucket: "forumjeda.firebasestorage.app",
